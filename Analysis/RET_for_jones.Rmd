...
The income of households has a dramatic impact on the effect of geography on households’ greenhouse gas (GHG) footprints (C. Jones & Kammen, 2014). High-income households in dense, accessible neighborhoods have a far lower GHG footprint than high-income households in far-flung exurbs, and this difference is much greater than the difference between low-income households in dense and exurban areas. The actions of local governments have a profound impact on the patterns of new housing construction by ther income of the population that moves into the units (Glaeser, Gyourko, & Saks, 2005; Terner Center for Housing Innovation, n.d.). We know the order-of-magnitude GHG effect of the siting of new housing in California (Decker et al., 2017; C. Jones & Kammen, 2015), but we don’t know the extent to which these impacts vary by geographic patterns of the incomes of households that move to those units. This is an important policy concern because the means of facilitating the development of housing for low- to moderate-income (LMI) families are very different than the means of facilitating the development of market-rate housing.
...
To take the example of the San Francisco Bay Area, under a priority affordable infill scenario extremely low income families will be. concentrated in the seven analysis areas in San Francisco. This is shown below

```{r map_egs, include = FALSE}
...
The market-rate infill scenario results in `r round((((infill_mkt_rate_ghg_total - infill_aff_ghg_total) / infill_aff_ghg_total) * 100), 1)`% less total household emissions than a priority affordable infill scenario. 
